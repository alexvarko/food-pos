...
<template>
      <div class="payment__form">
        ...
        <div class="payment__form-methods">
          <label for="card">
            <input type="radio" id="card" name="pay-method" value="card" checked />
          ...
          <label for="paypal">
            ...
            <svg width="20" height="20" viewBox="0 0 7.5 7.5" xmlns="http://www.w3.org/2000/svg" fill="red" stroke="red">
              <g stroke-width="0" />
