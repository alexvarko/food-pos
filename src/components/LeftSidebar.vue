...
watch(route, (to, from) => {
    activeButton.value = to.path === '/' ? 'home' : to.path.replace('/', '');
});

onMounted(() => {
    activeButton.value = route.path === '/' ? 'home' : route.path.replace('/', '');
});
    ...
    <div class="sidebar">
        <div class="sidebar__menu">
            <div class="sidebar__menu-item">
                <div class="sidebar__menu-item-center">
                    <div class="sidebar__menu-image-box store-box">
                        <img src="/static/sidebar/store.svg" />
                    </div>
                </div>
            </div>
            <div class="sidebar__menu-item" @click="activateButton('home')">
                <div :class="{ 'top--active': isActive('home') }">
                    <div :class="{ 'top-inner--active': isActive('home') }">
                        &nbsp;
                    </div>
                </div>

                <router-link to="/" class="sidebar__menu-item-center" :class="{ 'center--active': isActive('home') }">
                    <div class="sidebar__menu-image-box" :class="{ 'sidebar__menu-image--active': isActive('home') }">
                ...
                <div :class="{ 'bottom--active': isActive('home') }">
                    <div :class="{ 'bottom-inner--active': isActive('home') }">
                        &nbsp;
                    </div>
                </div>
            </div>
            <div class="sidebar__menu-item" @click="activateButton('discount')">
                <div :class="{ 'top--active': isActive('discount') }">
                    <div :class="{ 'top-inner--active': isActive('discount') }">
                        &nbsp;
                    </div>
                </div>
                <div class="sidebar__menu-item-center" :class="{ 'center--active': isActive('discount') }">
                    <div class="sidebar__menu-image-box"
                        :class="{ 'sidebar__menu-image--active': isActive('discount') }">
                        <a href="#">
                ...
                <div :class="{ 'bottom--active': isActive('discount') }">
                    <div :class="{ 'bottom-inner--active': isActive('discount') }">
                        &nbsp;
                    </div>
                </div>
            </div>
            <div class="sidebar__menu-item" @click="activateButton('dashboard')">
                <div :class="{ 'top--active': isActive('dashboard') }">
                    <div :class="{ 'top-inner--active': isActive('dashboard') }">
                        &nbsp;
                    </div>
                </div>
                <router-link to="/dashboard" class="sidebar__menu-item-center"
                    :class="{ 'center--active': isActive('dashboard') }">
                    <div class="sidebar__menu-image-box"
                        :class="{ 'sidebar__menu-image--active': isActive('dashboard') }">
                ...
                <div :class="{ 'bottom--active': isActive('dashboard') }">
                    <div :class="{ 'bottom-inner--active': isActive('dashboard') }">
                        &nbsp;
                    </div>
                </div>
            </div>
            <div class="sidebar__menu-item" @click="activateButton('messages')">
                <div :class="{ 'top--active': isActive('messages') }">
                    <div :class="{ 'top-inner--active': isActive('messages') }">
                        &nbsp;
                    </div>
                </div>
                <div class="sidebar__menu-item-center" :class="{ 'center--active': isActive('messages') }">
                    <div class="sidebar__menu-image-box"
                        :class="{ 'sidebar__menu-image--active': isActive('messages') }">
                        <a href="#">
                ...
                <div :class="{ 'bottom--active': isActive('messages') }">
                    <div :class="{ 'bottom-inner--active': isActive('messages') }">
                        &nbsp;
                    </div>
                </div>
            </div>
            <div class="sidebar__menu-item" @click="activateButton('notification')">
                <div :class="{ 'top--active': isActive('notification') }">
                    <div :class="{ 'top-inner--active': isActive('notification') }">
                        &nbsp;
                    </div>
                </div>
                <div class="sidebar__menu-item-center" :class="{ 'center--active': isActive('notification') }">
                    <div class="sidebar__menu-image-box"
                        :class="{ 'sidebar__menu-image--active': isActive('notification') }">
                        <a href="#">
                ...
                <div :class="{ 'bottom--active': isActive('notification') }">
                    <div :class="{ 'bottom-inner--active': isActive('notification') }">
                        &nbsp;
                    </div>
                </div>
            </div>
            <div class="sidebar__menu-item" @click="activateButton('settings')">
                <div :class="{ 'top--active': isActive('settings') }">
                    <div :class="{ 'top-inner--active': isActive('settings') }">
                        &nbsp;
                    </div>
                </div>
                <div class="sidebar__menu-item-center" :class="{ 'center--active': isActive('settings') }">
                    <div class="sidebar__menu-image-box"
                        :class="{ 'sidebar__menu-image--active': isActive('settings') }">
                ...
                <div :class="{ 'bottom--active': isActive('settings') }">
                    <div :class="{ 'bottom-inner--active': isActive('settings') }">
                        &nbsp;
                    </div>
                </div>
            </div>
            <div class="sidebar__menu-item" @click="activateButton('logout')">
                <div :class="{ 'top--active': isActive('logout') }">
                    <div :class="{ 'top-inner--active': isActive('logout') }">
                        &nbsp;
                    </div>
                </div>
                <div class="sidebar__menu-item-center" :class="{ 'center--active': isActive('logout') }">
                    <div class="sidebar__menu-image-box" :class="{ 'sidebar__menu-image--active': isActive('logout') }">
                        <a href="#">
                ...
                <div :class="{ 'bottom--active': isActive('logout') }">
                    <div :class="{ 'bottom-inner--active': isActive('logout') }">
                        &nbsp;
                    </div>
                </div>
            </div>
...
.center--active {
    background-color: var(--base-dark-bg-1);
    width: 100%;
