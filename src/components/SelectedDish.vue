...
const props = defineProps(['selectedDish', 'originalList'])




const deleteThisDish = (dish) => {

    console.log(props.originalList.indexOf(dish));
    props.originalList.splice(props.originalList.indexOf(dish),1)
}
</script>
...
.dish__total-qty {
    ...
    border: 1px solid;
    border-color: var(--base-dark-line);
    border-radius: 8px;
    text-align: center;
    font-family: 'Barlow';
    font-weight: 500;
